                ...
                case inclusion:
                    if ((textm == double_quote) && cb == '"')
                    {
                            ...
                            (!stack_lstr_search(buffer_ret->history, identifier)))
                        {
                            ...
                            cf_buffer *buffer_carrier = c_file_interpreter(identifier, p, profile, buffer_ret->history);
                            if (!buffer_carrier)
                            {
                                break;
                            }
                            ...
                            stack_str_append(buffer_ret->function_declarations, buffer_carrier->function_declarations);
                            stack_str_append(buffer_ret->function_references, buffer_carrier->function_references);
